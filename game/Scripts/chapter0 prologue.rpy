label prologue:
    ...
    # Show magical effect here of some kind
    ...
    # Show a scary image of vibrants attacking humans
    ...
    # disintegrate the image (shattering effect?)
    ...
    # show the spark of red on the world again

    s "Humanity’s greatest threat had also returned, predators of magic, Vibrants."

    # show vibrants attacking people again
    ...
    # hold for applause
    # play sound "applause"
    ## show sofi illuminated under the spotlight, the spotlight is obviously magic, she bows as more applause rains down, there's a crowd silhouette at the bottom of the screen

    ## slide BG to show camera facing Sofi, recording light turns off
    s "{i}sigh...{/i} It's finally over."
    ## play sound "continued applause"
