label chapter6:
    ...
    # btw for character positioning… breze and sofi should be next to each other, while tomo and flair are next to each other, so it should go something like: B S F T
    ...
    # beat, Flair and Breeze look at each other, then turn back to Tomo
    ...
    "Flair immediately patted Tomo’s shoulder to comfort her friend."
    ...
    f "I only came for Tomo, and you guys probably only came here to get info, right?"
    ...
    b "Good job."
    f "Also Tomo here can serve as a witness, right?"
    ...
    tm "I disagree."
    "We all looked to Tomo, who had a serious expression on her face."
    f "What are you talking about Tomo?"
    ...
    "I briefly explain to them that before they barged in, Tomo was already trying to unlock the elevator to retrieve something vital in another part of the facility."
    ...
    f "Hey, lay off!"
    "Flair stood between Breeze and Tomo, acting as a makeshift shield for the doctor."
    f "I admit, that this does sound suspicious, I get why you’d be hesitant, and yes maybe this is a mistake." 
    f "But Tomo is my friend!"
    f "And we promised to always trust each other when we were kids. I always keep my promises, and I know Tomo wouldn’t ask this if it wasn’t important."
    ". . . . . "
    ...
    "We all stood quiet for a moment. Tomo in particular looked down sullen, as if in deep thought."
    "But just as Flair was going to reprimand Breeze, Tomo finally let our a sigh."
